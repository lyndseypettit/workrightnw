...
-->             
         <div class="theme-inner-banner section-spacing"> 
             <div class="overlay"> 
                 <div class="container"> 
                     <h2><?php _e( 'Blog', 'charles_theme' ); ?></h2> 
                 </div>                     
                 <!-- /.container -->                     
             </div>                 
             <!-- /.overlay -->                 
                         ...
                         <div class="post-wrapper row"> 
                             <div class="col-md-6 col-12"> 
                                 <div class="single-blog"> 
                                     ...
                                     <!-- /.image-box -->                                         
                                     <div class="post-meta"> 
                                         <h5 class="title"><a href="blog-details.html"><?php _e( 'Trouble with the law since', 'charles_theme' ); ?></a></h5> 
                                         <p><?php _e( 'To seek out new life and new civilizations to boldly go where no man has gone before you would see the biggest gift.', 'charles_theme' ); ?></p> <a href="blog-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?></a> 
                                     </div>                                         
                                     <!-- /.post-meta -->                                         
                                 </div>                                     
                                 <!-- /.single-blog -->                                     
                             ...
                             <div class="col-md-6 col-12"> 
                                 <div class="single-blog"> 
                                     ...
                                     <!-- /.image-box -->                                         
                                     <div class="post-meta"> 
                                         <h5 class="title"><a href="blog-details.html"><?php _e( 'Kind of torture to have to watch', 'charles_theme' ); ?></a></h5> 
                                         <p><?php _e( 'To seek out new life and new civilizations to boldly go where no man has gone before you would see the biggest gift.', 'charles_theme' ); ?></p> <a href="blog-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?></a> 
                                     </div>                                         
                                     <!-- /.post-meta -->                                         
                                 </div>                                     
                             ...
                             <div class="col-md-6 col-12"> 
                                 <div class="single-blog"> 
                                     ...
                                     <!-- /.image-box -->                                         
                                     <div class="post-meta"> 
                                         <h5 class="title"><a href="blog-details.html"><?php _e( 'Make the best of things its an uphill.', 'charles_theme' ); ?></a></h5> 
                                         <p><?php _e( 'To seek out new life and new civilizations to boldly go where no man has gone before you would see the biggest gift.', 'charles_theme' ); ?></p> <a href="blog-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?></a> 
                                     </div>                                         
                                     <!-- /.post-meta -->                                         
                                 </div>                                     
