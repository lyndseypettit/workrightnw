             ...
             <div data-src="images/home/slide-1.jpg"> 
                 <div class="camera_caption"> 
                     <div class="container"> 
                         ...
                         <h1 class="wow fadeInUp animated" data-wow-delay="0.2s"><?php _e( 'We IMPROVE YOUR', 'charles_theme' ); ?> <br/><?php _e( 'SALES EFFICIENCY', 'charles_theme' ); ?></h1> <a href="contact.html" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s"><?php _e( 'CONTACT US', 'charles_theme' ); ?></a> 
                     </div>                         
                     ...
                     <div class="col-lg-6 col-12"> 
                         <div class="text"> 
                             <div class="theme-title-one"> 
                                 ...
                                 <p><?php _e( 'The government they survive as soldiers of fortune baby if you\'ve ever wondered the east side to a deluxe apartment.', 'charles_theme' ); ?></p> 
                             </div>                                 

                             <!-- /.theme-title-one -->                                 
                             <ul class="mission-goal clearfix"> 
                                 <li> <i class="icon flaticon-star"></i> 
                                     <h4><?php _e( 'Vision', 'charles_theme' ); ?></h4> 
                                 </li>                                     
                                 <li> <i class="icon flaticon-medal"></i> 
                                     <h4><?php _e( 'Missions', 'charles_theme' ); ?></h4> 
                                 </li>                                     
                                 <li> <i class="icon flaticon-target"></i> 
                                     <h4><?php _e( 'Goals', 'charles_theme' ); ?></h4> 
                                 </li>                                     
                             </ul>                                 
...
-->             
         <div class="service-style-one section-spacing"> 
             <div class="container"> 
                 <div class="theme-title-one"> 
                     <h2><?php _e( 'Our SERVICES', 'charles_theme' ); ?></h2> 
                     ...
                     <div class="row"> 
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     ...
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                         ...
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     <h5><a href="service-details.html"><?php _e( 'Consumer Product', 'charles_theme' ); ?></a></h5> 
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                         ...
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     <h5><a href="service-details.html"><?php _e( 'Financial Services', 'charles_theme' ); ?></a></h5> 
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                         ...
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     <h5><a href="service-details.html"><?php _e( 'Travel and Aviation', 'charles_theme' ); ?></a></h5> 
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                         ...
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     <h5><a href="service-details.html"><?php _e( 'Software Research', 'charles_theme' ); ?></a></h5> 
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                         ...
                         <div class="col-xl-4 col-md-6 col-12"> 
                             <div class="single-service"> 
                                 ...
                                 <div class="text"> 
                                     <h5><a href="service-details.html"><?php _e( 'Quality Resourcing', 'charles_theme' ); ?></a></h5> 
                                     <p><?php _e( 'The tiny ship today stiller', 'charles_theme' ); ?></p> <a href="service-details.html" class="read-more"><?php _e( 'READ MORE', 'charles_theme' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
                                 </div>                                     
                 ...
                 <div class="contact-text"> 
                     <h4><?php _e( 'You can also send us an email and we’ll get in touch shortly, or Call us', 'charles_theme' ); ?></h4> 
                     <h5><a href="#"><?php _e( 'info@support.com', 'charles_theme' ); ?></a> <?php _e( '(or)', 'charles_theme' ); ?> <a href="#"><?php _e( '+1 234 6780 900', 'charles_theme' ); ?></a></h5> 
                 </div>                     
             </div>                 
...
-->             
         <div class="our-team section-spacing"> 
             <div class="container"> 
                 <div class="theme-title-one"> 
                     <h2><?php _e( 'Our TEAM', 'charles_theme' ); ?></h2> 
                     <p><?php _e( 'A tale of a fateful trip that started from this tropic port aboard this tiny ship today stillers', 'charles_theme' ); ?></p> 
                 </div>                     
                     ...
                     <div class="row"> 
                         <div class="col-lg-3 col-sm-6 col-12"> 
                             <div class="team-member"> 
                                 <div class="image-box"> 
                                     ...
                                     <div class="overlay"> 
                                         <div class="hover-content"> 
                                             ...
                                             <p><?php _e( 'The government they survive as soldiers of fortune.', 'charles_theme' ); ?></p> 
                                         </div>                                             
                                 ...
                                 <!-- /.image-box -->                                     
                                 <div class="text"> 
                                     <h6><?php _e( 'Richards Mills', 'charles_theme' ); ?></h6> <span><?php _e( 'Sales Consultant', 'charles_theme' ); ?></span> 
                                 </div>                                     
                         ...
                         <div class="col-lg-3 col-sm-6 col-12"> 
                             <div class="team-member"> 
                                 ...
                                 <!-- /.image-box -->                                     
                                 <div class="text"> 
                                     <h6><?php _e( 'Mike Hussey', 'charles_theme' ); ?></h6> <span><?php _e( 'Founder, CEO', 'charles_theme' ); ?></span> 
                                 </div>                                     
                         ...
                         <div class="col-lg-3 col-sm-6 col-12"> 
                             <div class="team-member"> 
                                 ...
                                 <!-- /.image-box -->                                     
                                 <div class="text"> 
                                     <h6><?php _e( 'Jenilia D’sosa', 'charles_theme' ); ?></h6> <span><?php _e( 'Marketing Lead', 'charles_theme' ); ?></span> 
                                 </div>                                     
                         ...
                         <div class="col-lg-3 col-sm-6 col-12"> 
                             <div class="team-member"> 
                                 ...
                                 <!-- /.image-box -->                                     
                                 <div class="text"> 
                                     <h6><?php _e( 'David Warner', 'charles_theme' ); ?></h6> <span><?php _e( 'SEO Analyst', 'charles_theme' ); ?></span> 
                                 </div>                                     
...
-->             
         <div class="theme-counter section-spacing"> 
             <div class="container"> 
                 <div class="bg"> 
                     <h6><?php _e( 'Company Success', 'charles_theme' ); ?></h6> 
                     <h2><?php _e( 'Some fun facts about our consulting', 'charles_theme' ); ?></h2> 
                     ...
                     <!-- /.cunter-wrapper -->                         <a href="#" class="theme-button-one"><?php _e( 'VIEW CASE STUDIES', 'charles_theme' ); ?></a> 
                 </div>                     
