...
-->             
         <div class="theme-inner-banner section-spacing"> 
             <div class="overlay"> 
                 <div class="container"> 
                     <h2><?php _e( 'Our Expert', 'charles_theme' ); ?></h2> 
                 </div>                     
                 <!-- /.container -->                     
             </div>                 
             <!-- /.overlay -->                 
         ...
         <div class="consultation-form section-spacing"> 
             <div class="container"> 
                 <div class="theme-title-one"> 
                     <h2><?php _e( 'Get Appointment', 'charles_theme' ); ?></h2> 
                                 ...
                                 <div class="row"> 
                                     ...
                                     <div class="col-md-6"> 
                                         <select class="form-control" id="exampleSelect1"> 
                                             <option>
                                                 <?php _e( 'Whom you’re looking for?', 'charles_theme' ); ?>
                                             </option>                                                 
                                             <option>
                                                 <?php _e( 'Richards Mills', 'charles_theme' ); ?>
                                             </option>                                                 
                                             <option>
                                                 <?php _e( 'Mike Hussey', 'charles_theme' ); ?>
                                             </option>                                                 
                                             <option>
                                                 <?php _e( 'Jenilia D’sosa', 'charles_theme' ); ?>
                                             </option>                                                 
                                             <option>
                                                 <?php _e( 'David Warner', 'charles_theme' ); ?>
                                             </option>                                                 
                                         </select>                                             
                                     </div>                                         
                                     <div class="col-12">
