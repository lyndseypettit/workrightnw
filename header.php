...
<html <?php language_attributes(); ?>> 
    <head> 
        ...
        <meta name="theme-color" content="#7dc33b"/> 
        <!-- Windows Phone -->         
        <meta name="msapplication-navbutton-color" content="#7dc33b"/> 
        <!-- iOS Safari -->         
        <meta name="apple-mobile-web-app-status-bar-style" content="#7dc33b"/>          
        <!-- Favicon -->         
